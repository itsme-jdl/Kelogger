...
## Need to comment out the prints and exception prints on code when to use this for real, as its testing
## Prints are here to tell which part of the program is going at the time and that it is 
## working in CLI, GUI is on thr way

## need to config :
#       fromAddr = 'email_address'
#       fromPswd = 'password'
# To verify, you can check your Downloads or Pictures folder in Library, it will create the file there only
